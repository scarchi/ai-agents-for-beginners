# 【微軟官方神級免費課程《AI Agents for Beginners》🔥】

最近發現微軟 Microsoft 官方有釋出了一個完全免費的寶藏資源，在 GitHub 上已經衝破 61k+ 顆星！如果你想從單純的「下 Prompt」進階到打造「能自動幫你打工的 AI 團隊」，絕對不能錯過。
這套課程的架構非常完整，能幫你快速補齊打造 AI Agent 的所有核心知識：
🔹 基礎入門：什麼是 AI Agent？如何讓 Agent 調用 Tool / 最新的 MCP 協定。

🔹 核心架構：如何打造「多代理人系統」與管理脈絡（Context Engineering）。

🔹 進階落地：直接讓 AI 操作瀏覽器（Browser Use），以及如何安全部署 AI Agent 系統！

🔥最狠的是：它竟然直接支援 繁體中文 🇹🇼 教材！！！
怕看英文代碼痛苦的人，這下完全沒有藉口了。
現在 AI 發展速度太快，官方也在持續更新內容。每堂課除了觀念筆記，都附有 YouTube 講解影片 和實戰的 範例程式碼。
它不教你怎麼聊天下 Prompt，直接教你「怎麼讓 AI 幫你打工」。別再說你不知道怎麼開始學 AI 了，頂級免費資源真的太多了！
---正文開始---
